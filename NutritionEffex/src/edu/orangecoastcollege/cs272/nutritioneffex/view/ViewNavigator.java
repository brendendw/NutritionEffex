...
public class ViewNavigator 
{
	...
	public static final String CALORIES_BURNED_SCENE = "CaloriesBurnedCalculator.fxml";//done
	...
	public static final String FITNESS_TRANSITION_SCENE = "FitnessTransitionScene.fxml";//done
